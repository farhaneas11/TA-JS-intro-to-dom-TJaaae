...
allHrsArray.forEach(elm => elm.backgroundColor = "antiquewhite");
// Change the 'border-radius' of all the hr to "5px" using array.
allHrsArray.forEach(elm => elm.borderRadius = "antiquewhite");
// Change the alignment of the heading(h1) to center.
heading.style.textAlign="center";
// Change the font size of the heading to 3rem.
heading.style.fontSize="3rem";
// Change the border of hr with class 'image' to `2px solid purple`.
document.querySelectorAll("hr.img").forEach(elm => elm.style.border ="2px solid purple" );
...
para3.innerText = "Append inserts as last child ";
box3.prepend(para3);
...
let box9 = document.querySelector('.ninteen');
box9.append(btn);
...
imgEl.src = "https://images.unsplash.com/photo-1592500595497-d1f52a40b207?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&q=80"
